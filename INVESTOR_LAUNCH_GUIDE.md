...
| Resource | URL |
|----------|-----|
| **Live App** | https://vibetribe-2.preview.emergentagent.com |
| **Admin Dashboard** | https://vibetribe-2.preview.emergentagent.com/admin |
| **Analytics Dashboard** | https://vibetribe-2.preview.emergentagent.com/analytics |
...
curl "https://vibetribe-2.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_USER_ID"
```
...
FRONTEND_URL=https://vibetribe-2.preview.emergentagent.com
...
### Frontend (.env)
```
REACT_APP_BACKEND_URL=https://vibetribe-2.preview.emergentagent.com
...
curl -s "https://vibetribe-2.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_ADMIN_ID" | jq
```
