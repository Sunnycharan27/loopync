...
| Resource | URL |
|----------|-----|
| **Live App** | https://vibe-capsule.preview.emergentagent.com |
| **Admin Dashboard** | https://vibe-capsule.preview.emergentagent.com/admin |
| **Analytics Dashboard** | https://vibe-capsule.preview.emergentagent.com/analytics |
...
curl "https://vibe-capsule.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_USER_ID"
```
...
FRONTEND_URL=https://vibe-capsule.preview.emergentagent.com
...
### Frontend (.env)
```
REACT_APP_BACKEND_URL=https://vibe-capsule.preview.emergentagent.com
...
curl -s "https://vibe-capsule.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_ADMIN_ID" | jq
```
