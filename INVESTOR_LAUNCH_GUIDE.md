...
| Resource | URL |
|----------|-----|
| **Live App** | https://student-tribes.preview.emergentagent.com |
| **Admin Dashboard** | https://student-tribes.preview.emergentagent.com/admin |
| **Analytics Dashboard** | https://student-tribes.preview.emergentagent.com/analytics |
...
curl "https://student-tribes.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_USER_ID"
```
...
FRONTEND_URL=https://student-tribes.preview.emergentagent.com
...
### Frontend (.env)
```
REACT_APP_BACKEND_URL=https://student-tribes.preview.emergentagent.com
...
curl -s "https://student-tribes.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_ADMIN_ID" | jq
```
