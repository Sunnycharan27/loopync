...
| Resource | URL |
|----------|-----|
| **Live App** | https://social-prelaunch.preview.emergentagent.com |
| **Admin Dashboard** | https://social-prelaunch.preview.emergentagent.com/admin |
| **Analytics Dashboard** | https://social-prelaunch.preview.emergentagent.com/analytics |
...
curl "https://social-prelaunch.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_USER_ID"
```
...
FRONTEND_URL=https://social-prelaunch.preview.emergentagent.com
...
### Frontend (.env)
```
REACT_APP_BACKEND_URL=https://social-prelaunch.preview.emergentagent.com
...
curl -s "https://social-prelaunch.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_ADMIN_ID" | jq
```
