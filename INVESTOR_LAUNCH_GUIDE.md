...
| Resource | URL |
|----------|-----|
| **Live App** | https://loopync-social-4.preview.emergentagent.com |
| **Admin Dashboard** | https://loopync-social-4.preview.emergentagent.com/admin |
| **Analytics Dashboard** | https://loopync-social-4.preview.emergentagent.com/analytics |
...
curl "https://loopync-social-4.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_USER_ID"
```
...
FRONTEND_URL=https://loopync-social-4.preview.emergentagent.com
...
### Frontend (.env)
```
REACT_APP_BACKEND_URL=https://loopync-social-4.preview.emergentagent.com
...
curl -s "https://loopync-social-4.preview.emergentagent.com/api/analytics/admin?adminUserId=YOUR_ADMIN_ID" | jq
```
