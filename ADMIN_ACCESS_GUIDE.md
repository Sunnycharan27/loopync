...
### Login Page
```
https://vibetribe-2.preview.emergentagent.com/auth
```

### Admin Verification Dashboard
```
https://vibetribe-2.preview.emergentagent.com/admin/verification
```
...
### Step 1: Login
1. Go to: https://vibetribe-2.preview.emergentagent.com/auth
2. Enter your credentials
3. Click Login

### Step 2: Access Dashboard
1. Navigate to: https://vibetribe-2.preview.emergentagent.com/admin/verification
