...
class VibeCapsule(BaseModel):
    ...
    caption: str = ""
    music: Optional[dict] = None  # Spotify track data with startTime, clipDuration
    location: Optional[dict] = None  # {name, lat, lng}
...
async def get_me(current_user: dict = Depends(get_current_user)):
    ...
    """
    # The current_user is already the complete user data from auth_service
    return current_user
...
@api_router.get("/users/handle/{handle}", response_model=User)
