#!/usr/bin/env python3
"""
Verification Testing using curl commands for better reliability
"""
...
# Configuration
BACKEND_URL = "https://loopync-social-2.preview.emergentagent.com/api"

class CurlVerificationTester:
    def __init__(self):
...
async def main():
    print("🧪 Curl-based Verified Accounts & Special Pages Backend Testing")
    print("=" * 60)
    
    tester = CurlVerificationTester()
